...
import Place1 from '../../utils/images/place1.jpg';
...
import Acad1 from '../../utils/images/acad1.jpg';
import Acad2 from '../../utils/images/acad2.jpg';
                ...
                <div className='container'>
                    ...
                    <div className='row g-4'>
                        <div className='col-lg-4 d-flex-column align-items-center'>
                            ...
                            <h3 className='text-center mt-3'>Udm</h3>
                        </div>
                        <div className='col-lg-4 d-flex-column align-items-center'>
                            <img src={Place2}
                            className='img-fluid' alt ="" />
                        ...
                        <div className='col-lg-4 d-flex-column align-items-center'>
                            <img src={Acad1}
                            className='img-fluid' alt ="" />
                            <h3 className='text-center mt-3'>Udm Parade</h3>
                        </div>
                        <div className='col-lg-4 d-flex-column align-items-center'>
                            <img src={Acad2}
                            className='img-fluid' alt ="" />
                            <h3 className='text-center mt-3'>Udm Tambay</h3>
                        </div>
                    </div>
                </div>
            </div>
